                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                   		<c:forEach var="list" items="${listAllTask}">
											<tr>
												<td>${list.getId()}</td>
												<td>${list.getName()}</td>
												<td>${list.getJobId()}</td>
												...
												<td>${list.getStatusId()}</td>
												<td>
													<a href="<%=contextPath%>/task/edit?id=${list.getId()}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="<%=contextPath%>/task/delete?id=${list.getId()}" class="btn btn-sm btn-danger">Xoá</a> 
