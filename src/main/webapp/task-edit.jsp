            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="<%=contextPath%>/task/edit?id=${id}">
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="jobId">
                                            <c:forEach var="listJob" items="${listJob}">
                                            	<option value="${listJob.getId()}">${listJob.getName()}</option>                                        		
                                            </c:forEach>
                                        </select>
											<p class="text-left text-danger">Dự án cũ: ${job}</p>                                              
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc"
											...
											<p class="text-left text-danger">Tên công việc cũ: ${name}</p>                                              
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="userId">
											...
											<p class="text-left text-danger">Người thực hiện cũ: ${user}</p>                                                                                  
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                         <select class="form-control form-control-line" name="statusId">
                                            <c:forEach var="listStatus" items="${listStatus}">
                                            	<option value="${listStatus.getId()}">${listStatus.getName()}</option>	
                                            </c:forEach>
                                        </select>
											<p class="text-left text-danger">Tình trạng cũ: ${status}</p>                                                                                    
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
