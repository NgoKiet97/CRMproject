                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
										<c:forEach var="list" items="${listAllJob}">
											<tr>
												<td>${list.getId()}</td>
												<td>${list.getName()}</td>
												...
												<td>${list.getUser()}</td>
												<td><a href="<%=contextPath%>/job/edit?id=${list.getId()}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="<%=contextPath%>/job/delete?id=${list.getId()}" class="btn btn-sm btn-danger">Xoá</a>
													<a href="<%=contextPath%>/job/detail?id=${list.getId()}" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
