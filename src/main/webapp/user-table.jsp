                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                       	<c:forEach var="list" items="${listAllUser}">
											<tr>
												<td>${list.getId()}</td>
												<td>${list.getEmail()}</td>
												<td>${list.getFullname()}</td>
												<td>${list.getAvatar()}</td>
												<td>${list.getRole()}</td>
												<td>${list.getPhone()}</td>
												<td><a href="<%=contextPath%>/user/edit?id=${list.getId()}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="<%=contextPath%>/user/delete?id=${list.getId()}" class="btn btn-sm btn-danger">Xoá</a>
													<a href="<%=contextPath%>/user/detail?id=${list.getId()}" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>                                       
                                    </tbody>
