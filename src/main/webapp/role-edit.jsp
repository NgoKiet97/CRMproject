            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Chỉnh sửa thông tin quyền</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="<%=contextPath%>/role/edit?id=${id}">
                               
                                <div class="form-group">
                                    <label class="col-md-12">ID quyền cần chỉnh sửa thông tin</label>
                                    <div class="col-md-12">
                                        <p class="text-left text-danger">${id}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên quyền mới</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên quyền mới"
                                            class="form-control form-control-line" name="newName"/>
                                        <p class="text-left text-danger">Tên quyền cũ: ${name}</p>     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Mô tả mới</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Mô tả mới" class="form-control form-control-line" name="newDescription" />
