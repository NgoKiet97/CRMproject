            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=contextPath%>/job/edit?id=${id}" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">ID dự án cần chỉnh sửa</label>
                                    <div class="col-md-12">
                                    	<p class="text-left text-danger">${id}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên dự án mới</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên dự án"
                                            class="form-control form-control-line" name="name">
                                        <p class="text-left text-danger">Tên dự án cũ: ${name}</p>     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Mô tả mới</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Mô tả"
                                            class="form-control form-control-line" name="name">
                                        <p class="text-left text-danger">Mô tả cũ: ${description}</p>     
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p class="text-left text-danger">Ngày bắt đầu cũ: ${startDate}</p>     
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                    	...
                                    	<p class="text-left text-danger">Ngày kết thúc cũ: ${endDate}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Người quản lý mới</label>
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="userId">
                                            <c:forEach var="listUser" items="${listUser}">
                                            	<option value="${listUser.getId()}">${listUser.getFullname()}</option>	
                                            </c:forEach>
                                        </select>
                                        <p class="text-left text-danger">Người quản lý cũ: ${user}</p>     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
