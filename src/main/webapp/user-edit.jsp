            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material"  method="post" action="<%=contextPath%>/user/edit?id=${id}">
                                <div class="form-group">
                                    <label class="col-md-12">ID người dùng cần chỉnh sửa</label>
                                    <div class="col-md-12">
                                        <p class="text-left text-danger">${id}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Họ tên mới</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Họ tên" 
                                        class="form-control form-control-line" name="fullname">
                                        <p class="text-left text-danger">Họ tên cũ: ${fullname}</p>                                              
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email mới</label>
                                    <div class="col-md-12">
                                        <input type="email" placeholder="johnathan@admin.com"
                                            class="form-control form-control-line" name="email"
                                            id="example-email">
                                        <p class="text-left text-danger">Email cũ: ${email}</p>     
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                    	...
                                    	<p class="text-left text-danger">Avatar cũ: ${avatar}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-12">Chọn quyền thành viên mới</label>
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="roleId">
                                            <c:forEach var="list" items="${listAllRole}">
                                            	<option value="${list.getId()}">${list.getDescription()}</option>
                                            </c:forEach>
                                        </select>
                                        <p class="text-left text-danger">Quyền cũ: ${roleId}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p class="text-left text-danger">Số điện thoại cũ: ${phone}</p>     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
