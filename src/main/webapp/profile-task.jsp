                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<%=contextPath%>/profile?userId=<%=userId%>">Thông tin cá nhân</a></li>
                                    ...
                                    <tbody>
										<c:forEach var="task" items="${listTask}">
											<tr>
												...
												<td><a href="<%=contextPath%>/profile/edit?userId=<%=userId%>&id=${task.getId()}" class="btn btn-sm btn-primary">Cập nhật</a>
												</td>
											</tr>
										</c:forEach>
                                    </tbody>
